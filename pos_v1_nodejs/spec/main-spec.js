'use strict';
const {calTotalAndSaved,calSubtotal,getReceiptItemMsg,generateReceiptString,countBarcodeNum,formatCartBarcodeList,printReceipt,spiltBarcode}=require("../main/main");
